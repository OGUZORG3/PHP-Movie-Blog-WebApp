<?php require_once 'admin/baglantı.php';
...
<body>
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.php" style="Color:red;">SineHaber</a></h1>

      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li class="active"><a href="index.php">Ana sayfa</a></li>
          <li><a href="gununicerigi.php">Günün Filmi</a></li>
          <li><a href="blog.php">Haberler</a></li>
          <li><a href="iletişim.php">İletişim</a></li>
          <li><a href="Sanat.php">Tüm Sanatcılar</a></li>

        </ul>
      </nav><!-- .nav-menu -->

      <a href="admin/giris.php" class="get-started-btn">giriş</a>
